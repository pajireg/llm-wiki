...
7. **Write search-expansion fields** on every touched wiki page:
   ...
   These are indexed by FTS5 so synonym/concept queries surface the page; they are not displayed. Generated by the LLM, not by hand. Both are optional — omit a field only when nothing sensible applies; a missing field is fine.
